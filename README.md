# Gerador de Números de Celular (G.N.C)

Projeto criado em **HTML, CSS e JavaScript** para gerar números de celular aleatórios.  
...
1. Clone este repositório:
   ```bash
   git clone https://github.com/j4yh4ck3r/G.N.C.git
...
## Aprendizados
  ...
  - Estruturação de lógica simples em projetos práticos.
  - Experiência em transformar uma ideia própria em código, mesmo sem resultado perfeito.
